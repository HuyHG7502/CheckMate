...
namespace CheckMate.UI
{
    public class Button : IDrawable
    {
        ...
        public void Draw(SpriteBatch spriteBatch, AssetManager assetManager)
        {
            ...
            {
                if (IsClicked)
                    spriteBatch.Draw(assetManager.LoadColoredTexture(Colour.Karry), new Rectangle(Rect.X - 4, Rect.Y - 4, Rect.Width + 8, Rect.Height + 8), Color.White * 0.8f);
        ...
        public void Update(GameTime gameTime)
        {
            ...
            if (Action != null
                ...
                && GameUtil.IsMouseClicked(_current, _prev))
                Action();
        }
    }
}
